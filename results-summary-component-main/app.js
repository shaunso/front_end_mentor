...
////////////////////////////////////////////////////////////////////////////////////
  // using D3 to draw the graphs

  // parse the data file containing the data points of all user scores from the json file
  const dataD3 = await d3.json("data.json");
  
  



// get the width of the category div in order for D3 to draw the bar relative to the width
const width = document.getElementsByClassName("summary-item")[0].offsetWidth;
console.log(width);
}
